...
//This is the content of ws/app/controller/FileUploadDownloadController.java file.
import java.io.File;
...
@PostConstruct
public void init() {
String publicDir=context.getRealPath(context.getInitParameter("public_dir")) + File.separator;
